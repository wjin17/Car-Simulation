...
export function createMarioCircuit1(
  ...
  const TR1 = new TurnRoad(plane, SR3.offset, width, lanes, "CCW");
  ...
  const TR2 = new TurnRoad(plane, SR9.offset, width, lanes, "CCW");
  ...
  const TR3 = new TurnRoad(plane, SR12.offset, width, lanes, "CCW");
  ...
  const TR4 = new TurnRoad(plane, SR15.offset, width, lanes, "CW"); // problem child
  const SR16 = new StraightRoad(plane, TR4.offset, width, lanes);
  const SR17 = new StraightRoad(plane, SR16.offset, width, lanes);
  const TR5 = new TurnRoad(plane, SR17.offset, width, lanes, "CCW");
  const TR6 = new TurnRoad(plane, TR5.offset, width, lanes, "CCW");
